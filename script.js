document.addEventListener('DOMContentLoaded', function() {
    ...
    const birthdayData = {
        ...
        song: { file: "music/ordinary.mp3", title: "Ordinary - Alex Warren" }
    };
    const mainPlaylist = [
        { file: "music/leduong.mp3", title: "Lễ đường - Kai Đinh" }, 
        { file: "music/dieforyou.mp3", title: "Die For You - The Weeknd" },
        { file: "music/ordinary.mp3", title: "Ordinary - Alex Warren" },
        { file: "music/supernatural.mp3", title: "supernatural - Ariana Grande" },
        { file: "music/youngandbeautiful.mp3", title: "Young and Beautiful - Lana Del Rey" },
        { file: "music/tumblrgirls.mp3", title: "Tumblr Girls - G-Eazy" },
        { file: "music/sayyeslocopunch.mp3", title: "Say Yes - Loco x Punch" },
        { file: "music/carryyouhome.mp3", title: "Carry You Home - Alex Warren" },
        { file: "music/prada.mp3", title: "Prada - Cassö x Raye x D Block Europe" },
        { file: "music/phepmau.mp3", title: "Phép Màu - MAYDAYs ft.Minh Tốc" },
        { file: "music/paris.mp3", title: "Paris - The Chainsmokers" },
        { file: "music/wefoundlove.mp3", title: "We Found Love - Rihanna ft.Calvin Harris" },
        { file: "music/daylight.mp3", title: "Day Light - Taylor Swift" },
        { file: "music/angelnumbers.mp3", title: "Angel Numbers / Ten Toes - Chris Brown" },
        { file: "music/oneofthegirls.mp3", title: "One Of The Girls - The Weeknd, JENNIE, Lily-Rose Depp" },
        { file: "music/treatyoubetter.mp3", title: "Treat you better - Shawn Mendes " },
        { file: "music/goodforyou.mp3", title: "Good For You - Selena Gomez" },
        { file: "music/birdsofafeather.mp3", title: "Birds Of a Feather - Billie Eilish" },
        { file: "music/ladykillers.mp3", title: "Lady Killers II - G-Eazy" },
        { file: "music/allthestars.mp3", title: "All The Stars - Kendrick Lamar x SZA" },
    ];
    const dailySongs = [
        { day: 1, song: { file: "music/main/fever.mp3", title: "Fever - COLDZY" } },
        { day: 2, song: { file: "music/main/art.mp3", title: "Art - Tyla" } },
        { day: 3, song: { file: "music/main/nambenanh.mp3", title: "Nằm bên anh - Minh Đinh" } },
        { day: 4, song: { file: "music/main/Fantasize.mp3", title: "Fantasize - Ariana Grande" } },
        { day: 5, song: { file: "music/main/stillwithyou.mp3", title: "Still With You - Jung Kook" } },
        { day: 6, song: { file: "music/main/calloutmyname.mp3", title: "Call Out My Name - The Weeknd" } },
        { day: 7, song: { file: "music/main/khobaudanhroi.mp3", title: "Kho báu đánh rơi - tlinh" } },
        { day: 8, song: { file: "music/main/babyonemoretime.mp3", title: "Baby One More Time - Britney Spears" } },
        { day: 9, song: { file: "music/main/Snooze.mp3", title: "snooze - SZA" } },
        { day: 10, song: { file: "music/main/earnedit.mp3", title: "Earned It - The Weeknd" } }, 
        { day: 11, song: { file: "music/main/dearfuturehusband.mp3", title: "Dear Future Husband - Meghan Trainor" } },
        { day: 12, song: { file: "music/main/luther.mp3", title: "Luther - Kendrick Lamar & SZA" } },
        { day: 13, song: { file: "music/main/thegioithantien.mp3", title: "Thế giới thần tiên - tlinh" } },
        { day: 14, song: { file: "music/main/muathamlanggioi.mp3", title: "Mưa thâm lặng giời - BigDaddy ft.GREY D" } },
        { day: 15, song: { file: "music/main/afterlastnight.mp3", title: "After Last Night - Bruno Mars & Anderson Paak" } },
        { day: 16, song: { file: "music/main/Saturn.mp3", title: "Saturn - SZA" } },
        { day: 17, song: { file: "music/main/nuocmatdautheroiduoc.mp3", title: "Nước mắt đâu thể rơi được - 24kRight & tlinh" } },
        { day: 18, song: { file: "music/main/oldlove.mp3", title: "Old Love - Yuji ft. Putri Dahlia" } },
        { day: 19, song: { file: "music/main/only.mp3", title: "ONLY - LeeHi" } },
        { day: 20, song: { file: "music/main/detoiomembanggiaidieunay.mp3", title: "Để tôi ôm em bằng giai điệu này - Kai Dinh x Min x Grey D" } },
        { day: 21, song: { file: "music/main/lamlanhchuatinh.mp3", title: "Làm lành chữa tình - tlinh" } },
        { day: 22, song: { file: "music/main/SexyBack.mp3", title: "SexyBack - Justin Timberlake" } },
        { day: 23, song: { file: "music/main/duaemvenha.mp3", title: "đưa em về nhà - Grey D x Chillies" } },
        { day: 24, song: { file: "music/main/sayyes.mp3", title: "Say Yes - OgeNus x Pia Linh" } },
        { day: 25, song: { file: "music/shhhhhhh...mp3", title: "shhhhhhh.. - wean" } },
        { day: 26, song: { file: "music/main/Water.mp3", title: "Water - Tyla" } },
        { day: 27, song: { file: "music//main/standingnexttoyou.mp3", title: "Standing Next To You - Jung Kook" } },
        { day: 28, song: { file: "music/main/chamhoa.mp3", title: "Chăm Hoa - Mono" } },
        { day: 29, song: { file: "music/main/freakydeaky.mp3", title: "Freaky Deaky - Tyga x Doja Cat" } },
        { day: 30, song: { file: "music/openarms.mp3", title: "Open Arms - SZA" } },
        { day: 31, song: { file: "music/main/theboyismine.mp3", title: "The boy is mine - Ariana Grande" } }
    ];
    ...
    function setupEventListeners() {
        ...
        favoriteBtn.addEventListener('click', () => { let favorites = getFavorites(); const currentUrl = wavesurfer.getMediaElement().src; const currentFile = `music/${decodeURIComponent(currentUrl.split('/').pop())}`; if (favorites.includes(currentFile)) { favorites = favorites.filter(song => song !== currentFile); } else { favorites.push(currentFile); } saveFavorites(favorites); updateFavoriteButton(currentFile); });
